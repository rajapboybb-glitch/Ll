...
# Render portini tinglash uchun soxta veb-server funksiyasi
async def handle(request):
    return web.Response(text="Bot muvaffaqiyatli ishlayapti!")

    
    # Render so'rayotgan portni ishga tushirish (soxta server)
    ...
    # Bot so'rovlarini qabul qilishni boshlash
